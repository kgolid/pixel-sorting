...
let sketch = function(p) {
  ...
  function getOrigin(col_idx, row_idx, mat, sorted) {
    ...
    if (col_idx === 0)
      return meanCol(mat[row_idx][col_idx], mat[row_idx - 1][col_idx]);
    if (row_idx === 0)
      return meanCol(mat[row_idx][col_idx], sorted[col_idx - 1]);
    return meanCol(
      sorted[col_idx - 1],
      meanCol(mat[row_idx][col_idx], mat[row_idx - 1][col_idx])
    );
  }
